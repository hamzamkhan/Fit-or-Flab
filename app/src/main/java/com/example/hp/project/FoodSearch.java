...
public class FoodSearch extends Activity{
    ...
    public databasehelper_ dbHelper;
    static String xml = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dbHelper = new databasehelper_(this);
        populateRecent();
        dbHelper.close();
    }
    ...
    public class ParseXml extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String result) {
            ...
            SimpleAdapter adapter = new SimpleAdapter(getBaseContext(), rows, R.layout.searched_results, from, to);
